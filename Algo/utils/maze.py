...
from utils.mazegraph import MazeGraph
            ...
            if mazeGrid[i, j] != 1:
                ...
                for d in directions:
                    ...
                    if d == "N":
                        ...
                        if (
                            (i > 1)
                            and mazeGrid[i - 2, j] != 1
                            and mazeGrid[i - 2, j + 1] != 1
                            and mazeGrid[i - 2, j - 1] != 1
                        ):
                            if (
                                mazeGrid[i - 2, j] == ObstBoundary
                                or mazeGrid[i - 2, j + 1] == ObstBoundary
                                or mazeGrid[i - 2, j - 1] == ObstBoundary
                            ):
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i - row, j - col] == 1:
                                        ...
                                        break
                                    if (
                                        mazeGrid[i - row, j - 1] == 1
                                        or mazeGrid[i - row, j] == 1
                                        or mazeGrid[i - row, j + 1] == 1
                                    ):
                                        exit = True
                                        break
                        ...
                        if exit == False:
                            ...
                            if denote == False:
                                neighbors.append(
                                    ((i - 3, j - 3, "W"), 100, fwleftarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i + row, j - col] == 0.7:
                                        neighbors.append(
                                            ((i + 3, j - 3, "E"), 1000, bkleftarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i + 3, j - 3, "E"), 100, bkleftarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i + row, j + col] == 0.7:
                                        neighbors.append(
                                            ((i + 3, j + 3, "W"), 1000, bkrightarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i + 3, j + 3, "W"), 100, bkrightarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i + row, j + col] == 0.7:
                                        neighbors.append(
                                            ((i + 3, j + 3, "E"), 1000, fwleftarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i + 3, j + 3, "E"), 100, fwleftarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i + row, j - col] == 0.7:
                                        neighbors.append(
                                            ((i + 3, j - 3, "W"), 1000, fwrightarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i + 3, j - 3, "W"), 100, fwrightarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i - row, j + col] == 0.7:
                                        neighbors.append(
                                            ((i - 3, j + 3, "W"), 1000, bkleftarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i - 3, j + 3, "W"), 100, bkleftarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i - row, j - col] == 0.7:
                                        neighbors.append(
                                            ((i - 3, j - 3, "E"), 1000, bkrightarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i - 3, j - 3, "E"), 100, bkrightarr)
                                )  # increase weights to reduce turning
                    ...
                    if d == "W":  # facing the west direction
                        ...
                        if (
                            (j > 1)
                            and mazeGrid[i, j - 2] != 1
                            and mazeGrid[i - 1, j - 2] != 1
                            and mazeGrid[i + 1, j - 2] != 1
                        ):
                            if (
                                mazeGrid[i, j - 2] == 0.7
                                or mazeGrid[i - 1, j - 2] == 0.7
                                or mazeGrid[i + 1, j - 2] == 0.7
                            ):
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i + row, j - col] == 0.7:
                                        neighbors.append(
                                            ((i + 3, j - 3, "S"), 1000, fwleftarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i + 3, j - 3, "S"), 100, fwleftarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i - row, j - col] == 0.7:
                                        neighbors.append(
                                            ((i - 3, j - 3, "N"), 1000, fwrightarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i - 3, j - 3, "N"), 100, fwrightarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i + row, j + col] == 0.7:
                                        neighbors.append(
                                            ((i + 3, j + 3, "N"), 1000, bkleftarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i + 3, j + 3, "N"), 100, bkleftarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i - row, j + col] == 0.7:
                                        neighbors.append(
                                            ((i - 3, j + 3, "S"), 1000, bkrightarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i - 3, j + 3, "S"), 100, bkrightarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i + row, j + col] == 0.7:
                                        neighbors.append(
                                            ((i + 3, j + 3, "S"), 1000, fwrightarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i + 3, j + 3, "S"), 100, fwrightarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i - row, j + col] == 0.7:
                                        neighbors.append(
                                            ((i - 3, j + 3, "N"), 1000, fwleftarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i - 3, j + 3, "N"), 100, fwleftarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i - row, j - col] == 0.7:
                                        neighbors.append(
                                            ((i - 3, j - 3, "S"), 1000, bkleftarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i - 3, j - 3, "S"), 100, bkleftarr)
                                )  # increase weights to reduce turning
                        ...
                        if exit == False:
                            ...
                            for row in range(2, 5):
                                ...
                                for col in range(2, 5):
                                    if mazeGrid[i + row, j - col] == 0.7:
                                        neighbors.append(
                                            ((i + 3, j - 3, "N"), 1000, bkrightarr)
                                        )  # increase weights to reduce turning
                                        denote = True
                                        break
                            if denote == False:
                                neighbors.append(
                                    ((i + 3, j - 3, "N"), 100, bkrightarr)
                                )  # increase weights to reduce turning
