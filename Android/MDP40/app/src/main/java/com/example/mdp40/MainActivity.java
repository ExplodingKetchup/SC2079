...
public class MainActivity extends AppCompatActivity {
    ...
    private static final UUID my_uuid_insecure = UUID.fromString("58ab0158-8fcb-4d5d-b566-2306475dc59f");
    ...
    //UUID
    private static final UUID myUUID = UUID.fromString("58ab0158-8fcb-4d5d-b566-2306475dc59f");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TEXTVIEWS
        outputNotifView = (TextView) findViewById(R.id.status);
        ...
        ImageButton forwardButton = (ImageButton) findViewById(R.id.arrowUp);
        ...
        ImageButton backButton = (ImageButton) findViewById(R.id.arrowDown);
        ...
        View.OnClickListener movementOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Constants.connected) {
                    System.out.println("first fragment - CONNECTED");
